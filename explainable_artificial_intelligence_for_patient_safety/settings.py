...
ROOT_URLCONF = 'explainable_artificial_intelligence_for_patient_safety.urls'
...
WSGI_APPLICATION = 'explainable_artificial_intelligence_for_patient_safety.wsgi.application'
